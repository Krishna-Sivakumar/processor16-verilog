...
module InstructionMemory(
    ...
    initial begin
        // all registers are 0 by default. I use ADDI to initialize them as needed.
...
//        mem[3] = 16'h5_1_e_d;   // R[1] != R[15]? PC = PC + 1 - 3 (each addition is a word)
        ...
        // This program is the same as above, but I use jmp and beq here. I also load and store words.
